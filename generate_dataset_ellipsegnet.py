...
IMAGE_PAIRS = [
    {
        "left": f"{IMAGE_ROOT}/left_frame_001.jpg",
        "right": f"{IMAGE_ROOT}/right_frame_001.jpg",
        "left_points": {
            "point0": (298, 240),  # (col, row)
            "point1": (502, 234)
        },
        "right_points": {
            "point0": (130, 240),
    ...
    {
        "left": f"{IMAGE_ROOT}/left_frame_151.jpg",
        "right": f"{IMAGE_ROOT}/right_frame_151.jpg",
        "left_points": {
            "point0": (333, 242),
            "point1": (526, 231)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/left_frame_137.jpg",
        "right": f"{IMAGE_ROOT}/right_frame_137.jpg",
        "left_points": {
            "point0": (393, 243),
            "point1": (564, 225)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/left_frame_034.jpg",
        "right": f"{IMAGE_ROOT}/right_frame_034.jpg",
        "left_points": {
            "point0": (383, 242),
            "point1": (550, 226)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/left_frame_011.jpg",
        "right": f"{IMAGE_ROOT}/right_frame_011.jpg",
        "left_points": {
            "point0": (281, 240),
            "point1": (488, 236)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/p_left_100.jpg",
        "right": f"{IMAGE_ROOT}/p_right_100.jpg",
        "left_points": {
            "point0": (342, 193),
            "point1": (558, 175)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/p_left_400.jpg",
        "right": f"{IMAGE_ROOT}/p_right_400.jpg",
        "left_points": {
            "point0": (385, 190),
            "point1": (572, 175)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/p_left_1.jpg",
        "right": f"{IMAGE_ROOT}/p_right_1.jpg",
        "left_points": {
            "point0": (360, 191),
            "point1": (558, 177)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/c_left.jpg",
        "right": f"{IMAGE_ROOT}/c_right.jpg",
        "left_points": {
            "point0": (365, 306),
            "point1": (384, 302)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/left_frame.jpg",
        "right": f"{IMAGE_ROOT}/right_frame.jpg",
        "left_points": {
            "point0": (396, 272),
            "point1": (412, 269)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/left_frame_2562.jpg",
        "right": f"{IMAGE_ROOT}/right_frame_2562.jpg",
        "left_points": {
            "point0": (396, 272),
            "point1": (438, 268)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/left_frame_3146.jpg",
        "right": f"{IMAGE_ROOT}/right_frame_3146.jpg",
        "left_points": {
            "point0": (396, 272),
            "point1": (428, 268)
        },
    ...
    {
        "left": f"{IMAGE_ROOT}/left_frame_737.jpg",
        "right": f"{IMAGE_ROOT}/right_frame_737.jpg",
        "left_points": {
            "point0": (396, 272),
            "point1": (418, 270)
        },
